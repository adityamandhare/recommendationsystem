...
$sel="select follow_name, dd_strength from recommend_dd where username='".$_SESSION[username]."' order by dd_strength DESC";
...
<body>
<center>
<h2><font color="#808080">Diary-Diary Recommendation</font></h2>

<table width="70%" border="1" title="Diary-to-Diary Recommendation">
